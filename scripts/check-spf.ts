...
async function expandIncludes(record: SPFRecord, seen = new Set<string>(), depth = 0): Promise<SPFRecord> {
...
async function main() {
  ...
  console.log('Expanded mechanisms:', JSON.stringify(expanded.mechanisms, null, 2));
}
