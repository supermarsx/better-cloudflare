...
apiRouter.get('/api/zones/:zone/dns_records', asyncHandler(ServerAPI.getDNSRecords()));
apiRouter.post('/api/zones/:zone/dns_records', asyncHandler(ServerAPI.createDNSRecord()));
apiRouter.put('/api/zones/:zone/dns_records/:id', asyncHandler(ServerAPI.updateDNSRecord()));
apiRouter.delete('/api/zones/:zone/dns_records/:id', asyncHandler(ServerAPI.deleteDNSRecord()));
