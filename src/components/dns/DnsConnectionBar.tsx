    ...
    >
      <div className="flex min-w-0 flex-col items-stretch gap-2 min-[360px]:flex-row min-[360px]:items-center sm:flex-1">
        <span
          ...
          className="inline-flex shrink-0 self-start items-center gap-1 rounded-full border border-emerald-500/25 bg-emerald-500/10 px-2 py-1 text-[10px] font-medium text-emerald-500"
        >
          <ShieldCheck aria-hidden="true" className="h-3 w-3" />
          {t("Authenticated session", "Authenticated session")}
        </span>
