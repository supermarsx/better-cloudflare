    ...
    <div className="space-y-2 pt-4 border-t border-border">
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <Button
          ...
          className="col-span-2 bg-card/70 border border-border text-foreground/80 hover:bg-accent/60 hover:text-foreground hover:border-primary/30 transition-colors"
        >
          Manage Passkeys
        </Button>
      </div>
