...
>(({ className, size = "md", ...props }, ref) => (
  <SwitchPrimitives.Root
    className={cn(
      ...
      size === "xs" ? "h-5 w-9" : size === "sm" ? "h-6 w-10" : "h-7 w-12",
      className,
    )}
    {...props}
    ref={ref}
  >
    <SwitchPrimitives.Thumb
      className={cn(
        ...
        size === "xs"
          ? "h-4 w-4 shadow-[0_6px_14px_hsl(0_0%_0%_/_0.34)] data-[state=unchecked]:translate-x-0.5 data-[state=checked]:translate-x-[0.95rem]"
          : size === "sm"
