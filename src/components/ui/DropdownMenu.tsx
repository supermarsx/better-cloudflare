...
>(({ className, sideOffset = 4, collisionPadding = 12, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ...
    hideWhenDetached
    className={cn(
      "glass-surface glass-fade ui-menu-motion z-50 min-w-[8rem] overflow-hidden rounded-xl bg-popover/70 p-1 text-popover-foreground shadow-[0_18px_46px_hsl(0_0%_0%_/_0.28)]",
      className,
    )}
    {...props}
  />
