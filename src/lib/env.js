 ...
 */
export function getEnv(name, browserKey, defaultValue) {
 ...
 */
export function getEnvBool(name, browserKey, defaultValue = false) {
 ...
 */
export function getEnvNumber(name, browserKey, defaultValue) {
    const val = getEnv(name, browserKey);
    if (val === undefined)
        return defaultValue;
 ...
 */
export const RATE_LIMIT_WINDOW = getEnvNumber('RATE_LIMIT_WINDOW', 'VITE_RATE_LIMIT_WINDOW', 60_000);
export const RATE_LIMIT_MAX = getEnvNumber('RATE_LIMIT_MAX', 'VITE_RATE_LIMIT_MAX', 100);
